...
__published:	// IDE-managed Components
    ...
    TShape *Shape4;
    TLabel *Label5;
    TShape *shpColourHeld;
    TButton *cmdColourHeld;
    TShape *Shape5;
    TSpeedButton *cmdHold;
    TGroupBox *grpFreq;
    TRadioButton *opt1k;
    TRadioButton *opt200;
    TRadioButton *opt2k;
    ...
    void __fastcall cmdHoldClick(TObject *Sender);
    void __fastcall cmdColourHeldClick(TObject *Sender);
    void __fastcall grpFreqClick(TObject *Sender);
...
public:		// User declarations
    ...
    __property unsigned long Colour3  = { read=ulColour3, write=ulColour3 };
};
//---------------------------------------------------------------------------
