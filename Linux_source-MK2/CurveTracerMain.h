...
private:
    void OnbtnHoldSampleRightClick( wxCommandEvent& event );
    ...
    void OnbtnHeldClick(wxCommandEvent& event);
    void OnbtnHoldSampleClick(wxCommandEvent& event);
    void OnbtnToggleHoldToggle(wxCommandEvent& event);
    //*)
    ...
    static const long ID_BITMAPBTN_EVEN;
    static const long ID_STATICTEXT9;
    static const long ID_BITMAPBTN_ODD;
    static const long ID_STATICTEXT10;
    static const long ID_BITMAPBTN_STORE;
    ...
    wxTimer Timer1;
    wxToggleButton* btnToggleHold;
    //*)

    bool bReady = false;
    bool bCboPortEnabled = true;
    bool bShowHeldSample = false;
