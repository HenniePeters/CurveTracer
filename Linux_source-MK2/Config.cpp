...
void AppConfigData::Save( void ) {
    ...
    if( ! ReadOnly() ) {
        ...
        if( filestr.is_open() ) {
            ...
            if( Options["colour_store_r"] != "" ) {
                wxsTemp = _("colour_store_r = ") + _(Options["colour_store_r"].c_str()) + _("\n");
                filestr.write( wxsTemp.c_str(), wxsTemp.size() );
            }
            if( Options["colour_store_g"] != "" ) {
                wxsTemp = _("colour_store_g = ") + _(Options["colour_store_g"].c_str()) + _("\n");
                filestr.write( wxsTemp.c_str(), wxsTemp.size() );
            }
            if( Options["colour_store_b"] != "" ) {
                wxsTemp = _("colour_store_b = ") + _(Options["colour_store_b"].c_str()) + _("\n");
                filestr.write( wxsTemp.c_str(), wxsTemp.size() );
            }
            filestr.close();
        }
