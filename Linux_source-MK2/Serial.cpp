...
const char *comports[RS232_PORTNR] = {"\\\\.\\COM32", "\\\\.\\COM1",  "\\\\.\\COM2",  "\\\\.\\COM3",  "\\\\.\\COM4",
                                      "\\\\.\\COM5",  "\\\\.\\COM6",  "\\\\.\\COM7",  "\\\\.\\COM8",
...
int RS232_GetPortnr( const char *devname ) {
    ...
    for( i = 0; i < RS232_PORTNR; i++ ) {
        //wxMessageBox( _(str), _( "str" ) );
       //wxMessageBox( _(comports[i]), _( "comports[i]" ) );
        if( ! strcmp( comports[i], str ) ) {
            //wxMessageBox( _(comports[i]), _( "comport" ) );
            return i;
        }
    }
