...
void PaintGraphics::ChangeSamplesColour( wxColour ColourEven, wxColour ColourOdd, int iPenWidth ) {
...
void PaintGraphics::ShowSamples( struct f *fields ) {
    wxClientDC canvas( stArea );
    ...
    for( int i = 1; i < COORDS; i++ ) {
        ...
        d = map( fields->y[i], 0-fields->Vy, fields->Vy, iTopEdge+2, iBottomEdge-2 );
