...
const long CurveTracerDialog::ID_BITMAPBUTTON2 = wxNewId();
const long CurveTracerDialog::ID_STATICTEXT10 = wxNewId();
const long CurveTracerDialog::ID_BITMAPBUTTON1 = wxNewId();
...
CurveTracerDialog::CurveTracerDialog( wxWindow* parent, wxWindowID id ) {
    ...
    BoxSizer2->Add(btnAbout, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 4);
    ...
    lblProgress = new wxStaticText(this, ID_STATICTEXT3, _("/"), wxDefaultPosition, wxSize(45,30), wxALIGN_CENTRE, _T("ID_STATICTEXT3"));
    ...
    grpFrequency = new wxRadioBox(this, ID_RADIOBOX1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 2, __wxRadioBoxChoices_2, 1, wxRA_HORIZONTAL, wxDefaultValidator, _T("ID_RADIOBOX1"));
    grpFrequency->Hide();
    ...
    StaticText3 = new wxStaticText(this, ID_STATICTEXT8, _("Colour:"), wxDefaultPosition, wxSize(299,17), 0, _T("ID_STATICTEXT8"));
    BoxSizer15->Add(StaticText3, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxEXPAND, 5);
    BoxSizer16 = new wxBoxSizer(wxHORIZONTAL);
    StaticText6 = new wxStaticText(this, ID_STATICTEXT9, _("Even samples"), wxDefaultPosition, wxSize(104,17), 0, _T("ID_STATICTEXT9"));
    BoxSizer16->Add(StaticText6, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    btnEven = new wxBitmapButton(this, ID_BITMAPBUTTON2, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTON2"));
    BoxSizer16->Add(btnEven, 1, wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText7 = new wxStaticText(this, ID_STATICTEXT10, _("Odd samples"), wxDefaultPosition, wxSize(93,17), 0, _T("ID_STATICTEXT10"));
    BoxSizer16->Add(StaticText7, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    btnOdd = new wxBitmapButton(this, ID_BITMAPBUTTON1, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTON1"));
    BoxSizer16->Add(btnOdd, 1, wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    Connect(ID_BITMAPBUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&CurveTracerDialog::OnbtnEvenClick);
    Connect(ID_BITMAPBUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&CurveTracerDialog::OnbtnOddClick);
